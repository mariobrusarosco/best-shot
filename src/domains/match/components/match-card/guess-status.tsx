...
export const GuessStatus = ({ guess }: { guess: IGuess }) => {
	...
	if (guess.status === "expired")
		return (
			<AppPill.Component border="1px solid" borderColor="red.400" width={60} height={20}>
	...
	if (guess.status === "not-started")
		return (
			<AppPill.Component border="1px solid" borderColor="neutral.100" width={60} height={20}>
