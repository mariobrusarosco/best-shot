...
const StyledCheckbox = styled(MuiCheckbox)<AppCheckboxProps>(({ theme, variant, loading, error, success }) => ({
...
const StyledFormControlLabel = styled(FormControlLabel)<{ variant?: string }>(({ theme, variant }) => ({
	margin: 0,
