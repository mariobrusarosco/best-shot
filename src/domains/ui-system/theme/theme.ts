 ...
 * documented in docs/guides/comprehensive-mui-style-guide.md
 *
...
// Foundation imports
import { DESIGN_SYSTEM_COLORS, MUI_PALETTE_COLORS } from "./foundation/colors";
import { DESIGN_SYSTEM_SPACING, MUI_SPACING_CONFIG } from "./foundation/spacing";
import { MUI_TYPOGRAPHY_CONFIG } from "./foundation/typography";

// === TYPESCRIPT MODULE AUGMENTATION ===
// Must be declared before theme creation to ensure TypeScript recognizes custom variants
...
declare module "@mui/material/styles" {
	...
	// Extend card variants (Cards extend Paper component)
	...
	// Also extend Card variants for completeness
...
// Create the enhanced theme first
...
// Card overrides now handled by AppCard component directly - no theme overrides needed

// Add design system tokens and component overrides to theme
const enhancedTheme = createTheme(theme, {
	designSystem: {
		...DESIGN_SYSTEM_COLORS,
		...DESIGN_SYSTEM_SPACING,
	},
	// AppButton component handles its own styling, no theme overrides needed
});
...
// Export legacy tokens for backward compatibility during migration
export { COLORS, DESIGN_SYSTEM_COLORS as colors } from "./foundation/colors";
export { BORDER_RADIUS, DESIGN_SYSTEM_SPACING as spacing, PADDING } from "./foundation/spacing";

// Legacy theme compatibility exports
export const LEGACY_TOKENS = {
	...
	PADDING: DESIGN_SYSTEM_SPACING,
} as const;

// UIHelper already exported above at line 226
